...
<header class="mobile">
	<button onclick={toggleNav} aria-label="nav"><i class="fa-solid fa-bars"></i></button>
	<img src={headerLogo} alt="LiTHe Hax logo" />
	<button style:visibility="hidden" aria-label="nav"><i class="fa-solid fa-bars"></i></button>
